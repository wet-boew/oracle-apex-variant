...
BEGIN
        RETURN ' SELECT level, 
			pkg_poc_boew.f_tradc(nom_menu_fra, nom_menu_eng) label, 
			pkg_poc_boew.f_tradc(nom_lien_fra, nom_lien_eng) nom_lien,
		...
		CONNECT BY PRIOR ide_boew_menu = ide_boew_menu_parnt
		  ORDER SIBLINGS BY num_seqnc,
				    label' ;
		
END F_OBTNR_SQL_MENU ;	

-----------
-- 01.03 --	Fonction F_TRADC
-----------
